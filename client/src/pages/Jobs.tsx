...
// import { Search, MapPin, Briefcase, DollarSign, Filter, Loader2, Sparkles, ArrowRight } from 'lucide-react';
...
//   // Fetch Jobs with dynamic search and type filters
...
//           <p className="text-slate-500 mt-1">Find the perfect role to kickstart your career.</p>
//         </div>
...
//             className="w-full pl-14 pr-6 py-5 rounded-[24px] border-none ring-1 ring-slate-100 shadow-xl shadow-slate-100/30 focus:ring-2 focus:ring-blue-600 transition-all outline-none"
...
//           <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm sticky top-10 space-y-8">
...
//                       className="w-5 h-5 rounded-lg border-slate-200 text-blue-600 focus:ring-blue-500 cursor-pointer transition-all" 
//                     />
//                     <span className={`text-sm font-medium transition-colors ${selectedTypes.includes(type) ? 'text-slate-900' : 'text-slate-400'}`}>
//                       {type}
//                     </span>
//                   </label>
//                 ))}
...
//               <p className="font-bold uppercase tracking-widest text-xs">Fetching Roles...</p>
//             </div>
//           ) : (
//             <AnimatePresence>
...
//                   className="bg-white p-8 rounded-[32px] border border-slate-100 hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-100/40 transition-all cursor-pointer group"
//                 >
//                   <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
//                     <div className="flex items-center gap-6">
//                       <div className="w-16 h-16 bg-slate-900 text-white rounded-[20px] flex items-center justify-center font-black text-2xl shadow-lg group-hover:scale-110 transition-transform">
...
//                            <span className="flex items-center gap-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-wider bg-slate-50 px-3 py-1 rounded-lg">
//                              <Briefcase size={12} /> {job.type}
//                            </span>
//                            <span className="flex items-center gap-1.5 text-[10px] font-bold text-green-600 uppercase tracking-wider bg-green-50 px-3 py-1 rounded-lg">
//                              <DollarSign size={12} /> {job.salary || '$90k - $130k'}
//                            </span>
//                         </div>
//                       </div>
//                     </div>
                    
//                     <button className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-bold flex items-center gap-2 hover:bg-blue-600 transition-all group-hover:translate-x-1">
//                       View Role <ArrowRight size={18} />
//                     </button>
//                   </div>
//                 </motion.div>
//               ))}
...
//                <p className="text-slate-500 font-bold">No jobs matching your filters.</p>
//             </div>
//           )}
//         </div>
//       </div>
          ...
          <AnimatePresence mode="popLayout">
            {isLoading ? (
              ...
              <div className="glass p-20 rounded-[40px] border-2 border-dashed flex flex-col items-center justify-center text-center space-y-4">
                 ...
                 <button 
                  onClick={() => { setSearchTerm(''); setSelectedTypes(['Full-time', 'Internship', 'Remote', 'Part-time']); }}
